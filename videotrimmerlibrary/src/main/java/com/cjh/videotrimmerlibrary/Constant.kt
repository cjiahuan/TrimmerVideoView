...
class Constant {
    ...
    companion object {
        const val LOG_TAG = "videotrimmerlibrary"

        const val DEFAULT_TRIMMER_TIME = 10 * 1000L
        const val DEFAULT_THUMB_SHOW_COUNT = 10
        ...
        const val DEFAULT_SHAOW_COLOR = "#9a000000"
        const val DEFAULT_TRIMMER_COLRO = "#ffffff"
